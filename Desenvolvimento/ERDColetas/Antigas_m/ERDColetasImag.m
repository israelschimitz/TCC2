...
%ColetasImag40 OrdemImag40

%% Carregando a coleta e a ordem
load C:\Israel\Engenharia_Elétrica\Disciplinas\TCC1\Desenvolvimento\ERDColetas\Imag40.mat;
...
for k=1:(QuantColetas/2)
    DadosDireita(:,:,k) = ColetasImag40 (:,:,IndiceDir(k));
end
...
for k=1:(QuantColetas/2)
    DadosEsquerda(:,:,k) = ColetasImag40 (:,:,IndiceEsq(k));
end
