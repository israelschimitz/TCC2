...
%imag20_1903_1.mat Coletas1903Imag20israel1 Ordem1903Imag20israel1
%% Carregando a coleta e a ordem
load C:\Israel\Engenharia_Elétrica\Disciplinas\TCC1\Desenvolvimento\ERDColetas\imag20_1903_1.mat;
...
for i=1:QuantColetas
    if (mod(Ordem1903Imag20israel1(i),2) == 1)
        IndiceEsq(j,:) = i;
        j=j+1;
    else
        IndiceDir(k,:) = i;
...
for k=1:(QuantColetas/2)
    DadosDireita(:,:,k) = Coletas1903Imag20israel1 (:,:,IndiceDir(k));
end
...
for k=1:(QuantColetas/2)
    DadosEsquerda(:,:,k) = Coletas1903Imag20israel1(:,:,IndiceEsq(k));
end
